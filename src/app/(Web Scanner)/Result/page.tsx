    ...
    return (
            ...
            {results && (
                <div className='flex flex-col'>
                    ...
                    <div className=' rounded-3xl bg-white/20 p-5 px-5 py-5 m-10 pt-10 text-left text-white/90 shadow-2xl backdrop-blur-sm aos-init aos-animate flex flex-col items-center justify-center mx-3 md:mx-24'>
                        ...
                        <h1 className="md:text-7xl text-2xl font-mono font-bold text-white mb-4 text-center md:mt-20 mt-5">Scan Results</h1>
                        <p className='text-bold text-lg md:text-2xl bg-blend-soft-light mb-5'>Vulnerable&#9989; or Not &#10060; </p>
                        <div className='flex flex-row justify-evenly w-[70vw] '>
                            <div className='relative text-[15px] md:text-[30px]  font-semibold self-start text-black bg-gray-100 p-6  border-blue-300 rounded-lg '>
                                <p className=" mb-2">SQL Injection: {results.sqlInjection ? <span> &#9989;</span> : <span>&#10060;</span>}</p>
                                <p className=" mb-2">XSS: {results.xss ? <span> &#9989;</span> : <span>&#10060;</span>}</p>
                                <p className=" mb-2">Directory Traversal: {results.directoryTraversal ? <span> &#9989;</span> : <span>&#10060;</span>}</p>
                                <p className=" mb-2">Open Redirect: {results.openRedirect ? <span> &#9989;</span> : <span>&#10060;</span>}</p>
                            </div>
                            <Image
                        ...
                        <div className="flex flex-row justify-evenly items-stretch">
                            ...
                            />
                            <LinkPreview url="https://www.voltsec-io.com/" className="font-bold">
      ...
      <ul className=' flex flex-row justify-between items-center font-bold'>
        ...
        <li className='w-[45vw] text-right mr-14'>
            ...
            {errorStatus && <div className=""><ErrorPage
                error={error} /></div>}
        </div>
    );
